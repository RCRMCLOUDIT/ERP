<%-- 
    ...
    Created on : 06-26-2018, 02:06:16 AM
...
<%
    ...
    int NumeroLiquidacion, NumeroPedido, RecBod, TotalLineas;
...
<html>
    ...
    <body>
        <div id="EncabezadoPagina" style="background-color: #4682B4;">
            <center>
                <h1 style="color: #FFFFFF; text-align: center;">Editar Parametros de la Liquidacion</h1>
            </center>
        </div>
            ...
            <form id="UpdatePoliza" role='form' action='../ServletPoliza' method='POST'>
                ...
                <div id="tab-1"><%-- DIV DE PARAMETROS DE LA POLIZA --%>
                    ...
                    <div class="input-group">
                        ...
                        <input id="form-CstTotalFOB" name="form-CstTotalFOB" type="number" step="any" class="form-control col-sm-2" style="text-align: center" value="<%=TotalFOB%>">
                    </div>
                    <div class="input-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-2">
                        <a href="AgregaDetallePoliza.jsp?IdPoliza=<%=IdPoliza%>">
                            <button type='button' class='btn btn-primary'>Ir a Detalle Poliza</button>
                        </a>
                    </div>
                    <div class="col-2"> 
