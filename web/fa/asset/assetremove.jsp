...
<%! 
 static final String title = "P12120025"; 
 ...
 static final int DEPEDBEFORE_COL = 7;
%>
...
<BODY onload="myForm.removeDate.focus();">
<%
 ...
 String depBefore = assetRS.getString(DEPEDBEFORE_COL);
...
<FORM name="myForm" action="<%=rootPath%>" method="post" onsubmit='return remove_submit(myForm);'>
<INPUT type="hidden" name="_message" value="depall">
<INPUT type="hidden" name="assetId" value="<%=assetId%>">
<INPUT type="hidden" name="lastRunDate" value="<%=lastRunDate%>">
<INPUT type="hidden" name="depBefore" value="<%=depBefore%>">
...
<TABLE class="Border" width="600" cellspacing="1" cellpadding="0" border="0">
	<TR>
		<TD width="100%" class="tableheader" colspan="4" align="center"><%=rb.getString("P12120026")%></TD>
	</TR>
	<TR class="pcrinfo">
		<TD width="20%" class="label">&nbsp;<%=rb.getString("P12120027")%></TD>
    	<TD width="30%"><%=assetRS.getString(ASNAME_COL)%></TD>
		<TD width="25%" class="label"><%=rb.getString("P12120018")%></TD>
    ...
    <TR class="pcrinfo1">
      <TD class="label"><span class="textRed">*</span><%=rb.getString("P12120030")%></TD>
      <TD colspan="3"><INPUT size="10" maxlength="10" type="text" name="removeDate"  value="<%=removeDate%>" onkeyup="addSlash(myForm.removeDate)" onchange="formatDate(myForm.removeDate)" onkeypress="OnlyDigits();addSlash(myForm.removeDate)" onkeydown="return checkArrows(this, event)"><IMG src="../erp/ERP_COMMON/images/popcalendar/calendar.gif" border="0" onclick="popUpCalendar(this, myForm.removeDate, 'mm/dd/yyyy', 350, -1);" alt="Calendar"></TD>
	</TR>
<%	if(depBefore.equals("Y")){ %>
    <TR class="pcrinfo">
      <TD class="label">&nbsp;<%=rb.getString("P12120015")%></TD>
      <TD colspan="3">
...
<%	} %>
    <TR class="<%=depBefore.equals("Y")?"pcrinfo1":"pcrinfo"%>">
...
<TR><TD width="100%" align="center" height="30">
	<INPUT name="Submit" type="submit" class="button" value="<%=rb.getString("B00011")%>" onClick="myForm._message.value='remove';">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
